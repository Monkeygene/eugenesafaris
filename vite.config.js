  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        blackrhinoceros: path.resolve(__dirname, "wildlife/black-rhinoceros/index.html"),
        ...
        whiterhinoceros: path.resolve(__dirname, "wildlife/white-rhinoceros/index.html"),
        ...
        differencebetweenwhitandblackrhino: path.resolve(__dirname, "blog/difference-between-white-and-black-rhino/index.html"),
